...
<main>
  ...
  <section class="relative h-[420px] md:h-[520px]">
    <img src="<?php echo e(asset('images/hero.jpg')); ?>" class="absolute inset-0 w-full h-full object-cover" alt="hero">
  ...
  <section class="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 items-center px-4 py-12">
    <div class="flex justify-center">
      <img src="<?php echo e(asset('images/247.png')); ?>" class="h-44 md:h-56" alt="24/7">
    </div>
  ...
  <section id="kontak" class="relative">
    <img src="<?php echo e(asset('images/hall.jpg')); ?>" class="absolute inset-0 w-full h-full object-cover" alt="hall">
  ...
  <section class="max-w-6xl mx-auto grid md:grid-cols-2 gap-5 px-4 py-12" id="sop">
    ...
    <?php $__currentLoopData = $misi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="bg-white border rounded-2xl shadow-md p-5 flex items-start gap-3">
        ...
        <div class="font-semibold"><?php echo e($item); ?></div>
      </div>
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PKL\Form_Aduan_Samsat\frontend-laravel\resources\views/public/home.blade.php ENDPATH**/ ?>