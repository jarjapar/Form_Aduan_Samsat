  ...
  <header class="bg-[#0b5ea8] text-white sticky top-0 z-30">
    <div class="max-w-6xl mx-auto flex items-center justify-between px-4 py-3">
      <div class="flex items-center gap-3">
        <img src="<?php echo e(asset('images/logo.png')); ?>" class="h-9" alt="Logo" />
        <div class="font-bold tracking-wide">BAPPENDA NTB</div>
      </div>
      <nav class="hidden md:flex items-center gap-6 font-semibold">
        <a href="<?php echo e(route('landing')); ?>" class="hover:opacity-80">Beranda</a>
...
<?php /**PATH D:\PKL\Form_Aduan_Samsat\frontend-laravel\resources\views/layouts/public.blade.php ENDPATH**/ ?>